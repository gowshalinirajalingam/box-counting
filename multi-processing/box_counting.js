...
from BoxDetectionImports.core.Multiprocess_python_box import python_function
...
if __name__ == '__main__':
    ...
    while True:
        ...
        try:
            NoOfProcesses = msg["payload"]["NoOfProcessesForBoxCount"]
        ...
        try:
            ...
            if (video_ext in ['mjpeg','rtsp']) or (process=="canceled"):
                ...
                p = multiprocessing.Process(target=python_function, args=(msg,msg_local,current_process,exp_process,completed_process,msg_passing))
    ...
    RED.nodes.registerType('Box_counting', PythonFunction);
}